...
<button id="exportButton" class="styled-button" onclick="exportToExcel()" hidden>Excel</button> &nbsp;&nbsp;&nbsp;&nbsp;<a href='shiftreport.php' class='back-button'>Shift Report</a>
    | <a href='alldata.php' class='back-button'>All Records</a>
